...
Coord_HO Coord_IN::To_Coord_HO(const double(&missaligment)[3][3], RefrOpt Opt)
{
  double frh, alt, az;
  double tmp1[3][3];
  double tmp2[3][3];
...
Coord_EQ Coord_IN::To_Coord_EQ(const double(&missaligment)[3][3], RefrOpt Opt, double Lat)
{
  return To_Coord_HO(missaligment, Opt).To_Coord_EQ(Lat);
};
