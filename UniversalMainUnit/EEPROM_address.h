...
#define EE_currentSite      6

// Sites
#define SiteSize           32
#define maxNumSites         4

#define EE_sites          128
#define EE_site_lat         0
#define EE_site_long        4
#define EE_site_elev        8
#define EE_site_time       10
#define EE_site_name       11

#define SiteNameLen        16 // with null character!


// Mounts
#define MountSize           256
#define maxNumMounts         2

#define EE_Mounts           256

#define MountNameLen        16 // with null character!
