...
bool parkClearBacklash()
{
  ...
  cli();
  long    LastTimerRateAxis1 = staA1.timeByStep_Cur;
  long    LastTimerRateAxis2 = staA2.timeByStep_Cur;
  staA1.timeByStep_Cur = backlashA1.timerRate;
  staA2.timeByStep_Cur = backlashA2.timerRate;
  sei();
  ...
  cli();
  staA1.timeByStep_Cur = LastTimerRateAxis1;
  staA2.timeByStep_Cur = LastTimerRateAxis2;
  sei();
