...
#define FirmwareSubName "Validator"
// https://www.printables.com/fr/model/101944-laser-pointer-robot-remotelly-controlled-arduino-p


// MOUNT_TYPE_GEM = 1, MOUNT_TYPE_FORK = 2, MOUNT_TYPE_ALTAZM = 3, MOUNT_TYPE_FORK_ALT = 4
#define D_mountType 4

#define D_motorA1gear 40       // = physical ratio 
#define D_motorA1stepRot 20
#define D_motorA1micro 8        // microstep 0 to 8 : 1, 2, 4 ,8, 16, 32, 64, 128, 256
#define D_motorA1reverse 1
#define D_motorA1highCurr 800
#define D_motorA1lowCurr 400
#define D_motorA1silent 1

#define D_motorA2gear 30       // = physical ratio
#define D_motorA2stepRot 20
#define D_motorA2micro 8        // microstep 0 to 8 : 1, 2, 4 ,8, 16, 32, 64, 128, 256
#define D_motorA2reverse 1
#define D_motorA2highCurr 800
#define D_motorA2lowCurr 400
