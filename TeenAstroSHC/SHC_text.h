...
static_assert(sizeof(T_GEARCHECK)            <= SHC_MAXBYTES_R10, "T_GEARCHECK too wide for 128px (helvR10)");
static_assert(sizeof(T_GEARCHECK_EQ)         <= SHC_MAXBYTES_R10, "T_GEARCHECK_EQ too wide for 128px (helvR10)");
static_assert(sizeof(T_GEARCHECK_AZ)         <= SHC_MAXBYTES_R10, "T_GEARCHECK_AZ too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_PICK_HA)           <= SHC_MAXBYTES_R10, "T_GC_PICK_HA too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_PICK_DEC)          <= SHC_MAXBYTES_R10, "T_GC_PICK_DEC too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_PICK_AZ)           <= SHC_MAXBYTES_R10, "T_GC_PICK_AZ too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_PICK_ALT)          <= SHC_MAXBYTES_R10, "T_GC_PICK_ALT too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_RECENTER_OK)       <= SHC_MAXBYTES_R10, "T_GC_RECENTER_OK too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_CHECK_A1)          <= SHC_MAXBYTES_R10, "T_GC_CHECK_A1 too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_CHECK_A2)          <= SHC_MAXBYTES_R10, "T_GC_CHECK_A2 too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_SIMILAR)           <= SHC_MAXBYTES_R10, "T_GC_SIMILAR too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_SYNC_FIRST)        <= SHC_MAXBYTES_R10, "T_GC_SYNC_FIRST too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_THEN_GOTO)         <= SHC_MAXBYTES_R10, "T_GC_THEN_GOTO too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_RECENTER_EACH)     <= SHC_MAXBYTES_R10, "T_GC_RECENTER_EACH too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_LEG1)              <= SHC_MAXBYTES_R10, "T_GC_LEG1 too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_LEG2)              <= SHC_MAXBYTES_R10, "T_GC_LEG2 too wide for 128px (helvR10)");
static_assert(sizeof(T_GC_WAIT_SLEW)         <= SHC_MAXBYTES_R12, "T_GC_WAIT_SLEW too wide for 128px (helvR12)");
static_assert(sizeof(T_GC_RECENTER_OK)       <= SHC_MAXBYTES_R12, "T_GC_RECENTER_OK too wide for 128px (helvR12 DisplayMessage)");
