...
bool TGeoAlign::addStar(int I, int N, double RA, double Dec)
{
    ...
    AlignStars[I - 1].Dec = ((double) (long) targetAxis2.part.m) / StepsPerDegreeAxis2;
    ...
    if (I == 2)
    {
        ...
        if (syncEqu(RA, Dec))
        {
            ...
            double  IH3 = (IH2 + IH1) / 2.0;                     // average offset in HA
            double  ID3 = (ID2 - ID1) / 2.0;                     // new offset in Dec
